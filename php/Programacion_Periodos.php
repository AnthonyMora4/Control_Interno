...
$stmt = $conex->prepare("SELECT a.id_estado,b.fecha_hora_final FROM evaluacion_final a JOIN periodos b on a.id_periodo=b.id_periodo WHERE b.id_departamento=$id_depto");
$stmt->execute();
...
$stmt = $conex->prepare("SELECT a.id_periodo FROM periodos a WHERE a.id_departamento=$id_depto ORDER BY a.id_periodo");
$stmt->execute();
...
$resultado=mysqli_query($conex,$consulta2);//al ser un select guarda un 1 o mas si no hay errores y un 0 si los hay
$conex->close();
