...
$resultado1=mysqli_query($conex,$consulta1);//al ser un select guarda un 1 o mas si no hay errores y un 0 si los hay
}
...
$stmt = $conex->prepare("SELECT a.id_estado,b.id_periodo FROM evaluacion_final a JOIN periodos b on a.id_periodo=b.id_periodo WHERE b.id_departamento=$id_depto");
$stmt->execute();
